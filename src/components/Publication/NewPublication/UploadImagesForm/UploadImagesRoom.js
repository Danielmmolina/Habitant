  ...
  return (
    ...
    <> 
      <View style= {StylesUploadImages.containerTextImage}> 
        ...
        <Text style={{ ...StylesUploadImages.textImage, fontFamily: 'Montserrat_800ExtraBold'}}> Añadir fotos de la habitación </Text>
        <Text style= {{ ...StylesUploadImages.subtextImage, fontFamily: 'Montserrat_800ExtrBold'}}> Ejemplo: Una imagen que muestre la mayoria de la habitación. </Text>
